...
INSERT INTO DBSEGSYL.ROL(ID_ROL, NOMBRE, DESCRIPCION)
			VALUES (4, 'DELEGADO', 'RESPONSABLE DE COORDINACIONES ENTRE DOCENTE Y ALUMNOS');

INSERT INTO DBSEGSYL.ROL(ID_ROL, NOMBRE, DESCRIPCION)
			VALUES (5, 'DIRECTOR', 'DIRECTOR DE EAP - FISI ');

INSERT INTO DBSEGSYL.ROL(ID_ROL, NOMBRE, DESCRIPCION)
			VALUES (6, 'DECANO', 'DECANO DE LA FACULTAD DE INGENIERIA DE SISTEMAS E INFORMATICA');

--TABLA USUARIO
INSERT INTO DBSEGSYL.USUARIO (ID_USUARIO, NOMBRE, APELLIDO, CORREO, PASSWORD, TELEFONO, DIRECCION, ID_ROL)
			VALUES (1, 'LUCERO DEL PILAR','LIZA PUICAN', 'lliza0796@gmail.com', '1234', 999999999, 'Mz. Q Lote...',1);

INSERT INTO DBSEGSYL.USUARIO (ID_USUARIO, NOMBRE, APELLIDO, CORREO, PASSWORD, TELEFONO, DIRECCION, ID_ROL)
			VALUES (2, 'MAYCON','GUZMAN OSCATEGUI', 'mayconguzman@gmail.com', '1234', 999999999, 'Mz. Q Lote...',4);

INSERT INTO DBSEGSYL.USUARIO (ID_USUARIO, NOMBRE, APELLIDO, CORREO, PASSWORD, TELEFONO, DIRECCION, ID_ROL)
			VALUES (3, 'TAKESHI','FARRO', 'takeshifarro@gmail.com', '1234', 999999999, 'Mz. Q Lote...',1);

INSERT INTO DBSEGSYL.USUARIO (ID_USUARIO, NOMBRE, APELLIDO, CORREO, PASSWORD, TELEFONO, DIRECCION, ID_ROL)
			VALUES (4, 'LUIS','ALARCON', 'lalarcon@gmail.com', '1234', 999999999, 'Mz. Q Lote...',3);

INSERT INTO DBSEGSYL.USUARIO (ID_USUARIO, NOMBRE, APELLIDO, CORREO, PASSWORD, TELEFONO, DIRECCION, ID_ROL)
			VALUES (5, 'BRUNO','FRANCESCOLI', 'brunofrancescoli@gmail.com', '1234', 999999999, 'Mz. Q Lote...',2);

INSERT INTO DBSEGSYL.USUARIO (ID_USUARIO, NOMBRE, APELLIDO, CORREO, PASSWORD, TELEFONO, DIRECCION, ID_ROL)
			VALUES (6, 'DIRECTOR EAP','SW', 'directorsw@gmail.com', '1234', 999999999, 'Mz. Q Lote...',5);

INSERT INTO DBSEGSYL.USUARIO (ID_USUARIO, NOMBRE, APELLIDO, CORREO, PASSWORD, TELEFONO, DIRECCION, ID_ROL)
			VALUES (7, 'DIRECTOR EAP','SISTEMAS', 'directorsistemas@gmail.com', '1234', 999999999, 'Mz. Q Lote...',5);

INSERT INTO DBSEGSYL.USUARIO (ID_USUARIO, NOMBRE, APELLIDO, CORREO, PASSWORD, TELEFONO, DIRECCION, ID_ROL)
			VALUES (8, 'JUEVESAN CARLOS','GONZALES SUAREZ', 'juangonzales@gmail.com', '1234', 999999999, 'Mz. Q Lote...',6);

INSERT INTO DBSEGSYL.USUARIO (ID_USUARIO, NOMBRE, APELLIDO, CORREO, PASSWORD, TELEFONO, DIRECCION, ID_ROL)
			VALUES (9, 'CARLOS','YAÑEZ DURANTE', 'carlosyañes@gmail.com', '1234', 999999999, 'Mz. Q Lote...',2);
...
/********************************************************/
--TABLA SYLLABUS  /*verificar el campo estado, debería ser un char pero se declaró como integer
INSERT INTO DBSEGSYL.SYLLABUS (ID_SYLLABUS, ESTADO, FECHA_ENTREGA, FECHA_APROBACION, ID_ASIG_APERTURADA)
			VALUES(1, 'N', TO_DATE('15/08/2016','DD/MM/YYYY'), TO_DATE('25/08/2016','DD/MM/YYYY'), 1);

INSERT INTO DBSEGSYL.SYLLABUS (ID_SYLLABUS, ESTADO, FECHA_ENTREGA, FECHA_APROBACION, ID_ASIG_APERTURADA)
			VALUES(2, 'A', TO_DATE('15/08/2016','DD/MM/YYYY'), TO_DATE('25/08/2016','DD/MM/YYYY'), 4);

INSERT INTO DBSEGSYL.SYLLABUS (ID_SYLLABUS, ESTADO, FECHA_ENTREGA, FECHA_APROBACION, ID_ASIG_APERTURADA)
			VALUES(3, 'R', TO_DATE('15/08/2016','DD/MM/YYYY'), TO_DATE('25/08/2016','DD/MM/YYYY'), 3);

INSERT INTO DBSEGSYL.SYLLABUS (ID_SYLLABUS, ESTADO, FECHA_ENTREGA, FECHA_APROBACION, ID_ASIG_APERTURADA)
			VALUES(4, 'A', TO_DATE('15/08/2016','DD/MM/YYYY'), TO_DATE('25/08/2016','DD/MM/YYYY'), 2);
...
INSERT INTO DBSEGSYL.TEMA (ID_TEMA, DESCRIPCION, UNIDAD, SEMANA, ID_SYLLABUS)
			VALUES(1, 'CLASE INTRODUCTORIA', 1, 1, 1 );

INSERT INTO DBSEGSYL.TEMA (ID_TEMA, DESCRIPCION, UNIDAD, SEMANA, ID_SYLLABUS)
			VALUES(2, 'ASDTX	ASDASD', 3, 2, 2 );

INSERT INTO DBSEGSYL.TEMA (ID_TEMA, DESCRIPCION, UNIDAD, SEMANA, ID_SYLLABUS)
			VALUES(3, 'GRAFOOOOOOS', 2, 4, 2 );

INSERT INTO DBSEGSYL.TEMA (ID_TEMA, DESCRIPCION, UNIDAD, SEMANA, ID_SYLLABUS)
			VALUES(4, 'YYYYYYYYYYYYYYYYY', 5, 3, 1 );

INSERT INTO DBSEGSYL.TEMA (ID_TEMA, DESCRIPCION, UNIDAD, SEMANA, ID_SYLLABUS)
			VALUES(5, 'REEEEEEEEEEEEEEEES', 4, 7, 2 );
