...
<body>
	...
	<div class="content">
		...
		<div class="panel panel-info">
			...
			Validar Syllabus<span style="padding-left: 10px;" class="glyphicon glyphicon-user" aria-hidden="true"></span>
			</button>
			</div>
		</div>
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title" id="exampleModalLabel">Detalle de Syllabus</h4>
		      </div>
		      <div class="modal-body">
				<div class="row">
					<div class="col-md-3" style="padding-top: 1%;padding-bottom: 2%">
					    Fecha de Publicación
					  </div>
					  <div class="col-md-3" style="padding-top: 1%;padding-bottom: 2%">
					    <div class="input-group">
					      <input disabled type="text" class="form-control" value="12/08/2016">
					...
					<div class="col-md-3" style="padding-top: 1%;padding-bottom: 2%">
					  ...
					  <div class="col-md-3" style="padding-top: 1%;padding-bottom: 2%">
					    <div class="input-group">
					      <input disabled type="text" class="form-control" value="11:44:32 am">
					     
					    </div>
					  </div>
				</div>
				<div class="row">
					<p>Ingresar un comentario</p>
					<textarea>
						Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
						Nam tristique dapibus mi at porttitor. Maecenas vehicula 
						turpis sed venenatis pellentesque. Aliquam vehicula nunc 
						non neque condimentum, quis finibus libero blandit. Morbi 
