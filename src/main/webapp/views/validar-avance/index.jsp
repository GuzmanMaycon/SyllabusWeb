...
<head>
  ...
  <title>Validar Avance del Docente</title>
</head>
<body id="app">
  ...
  <div class="content">
    ...
    <form method="POST">
    <div class="row">
      <h2>Validación de avance del Curso de ${ nombreAsignatura }</h2>
    </div>
          ...
          <div class="panel-body">
            <div class="text-center">
              <c:choose>
                ...
                <c:otherwise>
                <a class="btn" href="${basePath}/grupo/${grupoId}/sesion/${sesion.id}/valida">
